...
public class SPARK_MultilayerPerceptronClassifier_AtomlTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            { new String[]{"setMaxIter","100","setStepSize","0.3","setSolver","gd","setTol","0.000001"}, "setMaxIter 100 setStepSize 0.3 setSolver gd setTol 0.000001"},
            { new String[]{"setMaxIter","100","setStepSize","0.3","setSolver","l-bfgs","setTol","0.000001"}, "setMaxIter 100 setStepSize 0.3 setSolver l-bfgs setTol 0.000001"},
            { new String[]{"setMaxIter","100","setStepSize","0.1","setSolver","l-bfgs","setTol","0.000001"}, "setMaxIter 100 setStepSize 0.1 setSolver l-bfgs setTol 0.000001"},
            { new String[]{"setMaxIter","100","setStepSize","0.5","setSolver","l-bfgs","setTol","0.000001"}, "setMaxIter 100 setStepSize 0.5 setSolver l-bfgs setTol 0.000001"},
            { new String[]{"setMaxIter","1","setStepSize","0.3","setSolver","l-bfgs","setTol","0.000001"}, "setMaxIter 1 setStepSize 0.3 setSolver l-bfgs setTol 0.000001"},
            { new String[]{"setMaxIter","500","setStepSize","0.3","setSolver","l-bfgs","setTol","0.000001"}, "setMaxIter 500 setStepSize 0.3 setSolver l-bfgs setTol 0.000001"},
            { new String[]{"setMaxIter","999","setStepSize","0.3","setSolver","l-bfgs","setTol","0.000001"}, "setMaxIter 999 setStepSize 0.3 setSolver l-bfgs setTol 0.000001"},
            { new String[]{"setMaxIter","100","setStepSize","0.3","setSolver","l-bfgs","setTol","0.00001"}, "setMaxIter 100 setStepSize 0.3 setSolver l-bfgs setTol 0.00001"},
            { new String[]{"setMaxIter","100","setStepSize","0.3","setSolver","l-bfgs","setTol","0.0000001"}, "setMaxIter 100 setStepSize 0.3 setSolver l-bfgs setTol 0.0000001"}
           });
    }
