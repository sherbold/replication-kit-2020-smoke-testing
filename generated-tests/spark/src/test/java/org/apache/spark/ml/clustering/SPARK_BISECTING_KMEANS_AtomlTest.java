...
public class SPARK_BISECTING_KMEANS_AtomlTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            { new String[]{"minDivisibleClusterSize","1.0","maxIter","50","k","2"}, "minDivisibleClusterSize 1.0 maxIter 50 k 2"},
            { new String[]{"minDivisibleClusterSize","1.0","maxIter","50","k","3"}, "minDivisibleClusterSize 1.0 maxIter 50 k 3"},
            { new String[]{"minDivisibleClusterSize","1.0","maxIter","50","k","4"}, "minDivisibleClusterSize 1.0 maxIter 50 k 4"},
            { new String[]{"minDivisibleClusterSize","1.0","maxIter","0","k","2"}, "minDivisibleClusterSize 1.0 maxIter 0 k 2"},
            { new String[]{"minDivisibleClusterSize","1.0","maxIter","100","k","2"}, "minDivisibleClusterSize 1.0 maxIter 100 k 2"},
            { new String[]{"minDivisibleClusterSize","0.5","maxIter","50","k","2"}, "minDivisibleClusterSize 0.5 maxIter 50 k 2"},
            { new String[]{"minDivisibleClusterSize","1.5","maxIter","50","k","2"}, "minDivisibleClusterSize 1.5 maxIter 50 k 2"}
           });
    }
    ...
    public void test_Uniform() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            BisectingKMeans clusterer = new BisectingKMeans();
            try {
            ...
            BisectingKMeansModel model = clusterer.fit(dataframe);
