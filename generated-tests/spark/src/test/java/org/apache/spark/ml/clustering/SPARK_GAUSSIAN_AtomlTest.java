...
public class SPARK_GAUSSIAN_AtomlTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            { new String[]{"tol","0.2","maxIter","50","k","2"}, "tol 0.2 maxIter 50 k 2"},
            { new String[]{"tol","0.2","maxIter","50","k","3"}, "tol 0.2 maxIter 50 k 3"},
            { new String[]{"tol","0.2","maxIter","50","k","4"}, "tol 0.2 maxIter 50 k 4"},
            { new String[]{"tol","0.2","maxIter","0","k","2"}, "tol 0.2 maxIter 0 k 2"},
            { new String[]{"tol","0.2","maxIter","100","k","2"}, "tol 0.2 maxIter 100 k 2"},
            { new String[]{"tol","0.1","maxIter","50","k","2"}, "tol 0.1 maxIter 50 k 2"},
            { new String[]{"tol","0.3","maxIter","50","k","2"}, "tol 0.3 maxIter 50 k 2"}
           });
    }
    ...
    public void test_Uniform() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            GaussianMixture clusterer = new GaussianMixture();
            try {
            ...
            GaussianMixtureModel model = clusterer.fit(dataframe);
