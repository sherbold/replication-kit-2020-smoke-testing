...
public class SPARK_NaiveBayes_AtomlTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            { new String[]{"setSmoothing","1.0","setModelType","multinomial"}, "setSmoothing 1.0 setModelType multinomial"},
            { new String[]{"setSmoothing","1.0","setModelType","complement"}, "setSmoothing 1.0 setModelType complement"},
            { new String[]{"setSmoothing","0.0","setModelType","multinomial"}, "setSmoothing 0.0 setModelType multinomial"},
            { new String[]{"setSmoothing","0.5","setModelType","multinomial"}, "setSmoothing 0.5 setModelType multinomial"}
           });
    }
