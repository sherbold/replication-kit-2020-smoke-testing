...
public class SPARK_NaiveBayes_Bernoulli_AtomlTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            { new String[]{"setSmoothing","1.0","setModelType","bernoulli"}, "setSmoothing 1.0 setModelType bernoulli"},
            { new String[]{"setSmoothing","0.0","setModelType","bernoulli"}, "setSmoothing 0.0 setModelType bernoulli"},
            { new String[]{"setSmoothing","0.5","setModelType","bernoulli"}, "setSmoothing 0.5 setModelType bernoulli"}
           });
    }
