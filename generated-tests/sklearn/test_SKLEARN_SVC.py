...
class test_SKLEARN_SVC(unittest.TestCase):

    params = [("{'tol':0.001,'shrinking':True,'C':0.1,'kernel':'rbf','probability':False,'class_weight':'None+10','gamma':'scale',}", {'tol':0.001,'shrinking':True,'C':0.1,'kernel':'rbf','probability':False,'class_weight':'None+10','gamma':'scale',}),
              ("{'tol':0.001,'shrinking':True,'C':1.0,'kernel':'rbf','probability':False,'class_weight':'None+10','gamma':'scale',}", {'tol':0.001,'shrinking':True,'C':1.0,'kernel':'rbf','probability':False,'class_weight':'None+10','gamma':'scale',}),
              ("{'tol':0.001,'shrinking':True,'C':1.9,'kernel':'rbf','probability':False,'class_weight':'None+10','gamma':'scale',}", {'tol':0.001,'shrinking':True,'C':1.9,'kernel':'rbf','probability':False,'class_weight':'None+10','gamma':'scale',}),
              ("{'tol':0.001,'shrinking':True,'C':1.0,'kernel':'linear','probability':False,'class_weight':'None+10','gamma':'scale',}", {'tol':0.001,'shrinking':True,'C':1.0,'kernel':'linear','probability':False,'class_weight':'None+10','gamma':'scale',}),
              ("{'tol':0.001,'shrinking':True,'C':1.0,'kernel':'rbf','probability':False,'class_weight':'None+10','gamma':'auto',}", {'tol':0.001,'shrinking':True,'C':1.0,'kernel':'rbf','probability':False,'class_weight':'None+10','gamma':'auto',}),
              ("{'tol':0.001,'shrinking':True,'C':1.0,'kernel':'rbf','probability':False,'class_weight':'None+10','gamma':0.1,}", {'tol':0.001,'shrinking':True,'C':1.0,'kernel':'rbf','probability':False,'class_weight':'None+10','gamma':0.1,}),
              ("{'tol':0.001,'shrinking':False,'C':1.0,'kernel':'rbf','probability':False,'class_weight':'None+10','gamma':'scale',}", {'tol':0.001,'shrinking':False,'C':1.0,'kernel':'rbf','probability':False,'class_weight':'None+10','gamma':'scale',}),
              ("{'tol':0.001,'shrinking':True,'C':1.0,'kernel':'rbf','probability':True,'class_weight':'None+10','gamma':'scale',}", {'tol':0.001,'shrinking':True,'C':1.0,'kernel':'rbf','probability':True,'class_weight':'None+10','gamma':'scale',}),
              ("{'tol':0.001,'shrinking':True,'C':1.0,'kernel':'rbf','probability':False,'class_weight':'balanced','gamma':'scale',}", {'tol':0.001,'shrinking':True,'C':1.0,'kernel':'rbf','probability':False,'class_weight':'balanced','gamma':'scale',}),
              ("{'tol':0.001,'shrinking':True,'C':1.0,'kernel':'rbf','probability':False,'class_weight':None,'gamma':'scale',}", {'tol':0.001,'shrinking':True,'C':1.0,'kernel':'rbf','probability':False,'class_weight':None,'gamma':'scale',}),
             ]
