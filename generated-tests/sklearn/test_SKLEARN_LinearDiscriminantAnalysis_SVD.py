...
class test_SKLEARN_LinearDiscriminantAnalysis_SVD(unittest.TestCase):

    params = [("{'n_components':None,'tol':0.0001,'store_covariance':False,'shrinkage':None,'solver':'svd',}", {'n_components':None,'tol':0.0001,'store_covariance':False,'shrinkage':None,'solver':'svd',}),
              ("{'n_components':1,'tol':0.0001,'store_covariance':False,'shrinkage':None,'solver':'svd',}", {'n_components':1,'tol':0.0001,'store_covariance':False,'shrinkage':None,'solver':'svd',}),
              ("{'n_components':None,'tol':0.0001,'store_covariance':True,'shrinkage':None,'solver':'svd',}", {'n_components':None,'tol':0.0001,'store_covariance':True,'shrinkage':None,'solver':'svd',}),
             ]
