...
class test_SKLEARN_Birch(unittest.TestCase):

    params = [("{'n_clusters':2,'threshold':0.5,'copy':True,'branching_factor':50,}", {'n_clusters':2,'threshold':0.5,'copy':True,'branching_factor':50,}),
              ("{'n_clusters':2,'threshold':1.0,'copy':True,'branching_factor':50,}", {'n_clusters':2,'threshold':1.0,'copy':True,'branching_factor':50,}),
              ("{'n_clusters':2,'threshold':0.5,'copy':True,'branching_factor':10,}", {'n_clusters':2,'threshold':0.5,'copy':True,'branching_factor':10,}),
              ("{'n_clusters':2,'threshold':0.5,'copy':True,'branching_factor':90,}", {'n_clusters':2,'threshold':0.5,'copy':True,'branching_factor':90,}),
              ("{'n_clusters':3,'threshold':0.5,'copy':True,'branching_factor':50,}", {'n_clusters':3,'threshold':0.5,'copy':True,'branching_factor':50,}),
              ("{'n_clusters':4,'threshold':0.5,'copy':True,'branching_factor':50,}", {'n_clusters':4,'threshold':0.5,'copy':True,'branching_factor':50,}),
              ("{'n_clusters':2,'threshold':0.5,'copy':False,'branching_factor':50,}", {'n_clusters':2,'threshold':0.5,'copy':False,'branching_factor':50,}),
             ]
