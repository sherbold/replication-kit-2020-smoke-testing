...
class test_SKLEARN_GaussianProcessClassifier(unittest.TestCase):

    params = [("{'optimizer':'fmin_l_bfgs_b','max_iter_predict':100,'n_restarts_optimizer':0,'copy_X_train':True,}", {'optimizer':'fmin_l_bfgs_b','max_iter_predict':100,'n_restarts_optimizer':0,'copy_X_train':True,}),
              ("{'optimizer':'fmin_l_bfgs_b','max_iter_predict':100,'n_restarts_optimizer':1,'copy_X_train':True,}", {'optimizer':'fmin_l_bfgs_b','max_iter_predict':100,'n_restarts_optimizer':1,'copy_X_train':True,}),
              ("{'optimizer':'fmin_l_bfgs_b','max_iter_predict':100,'n_restarts_optimizer':2,'copy_X_train':True,}", {'optimizer':'fmin_l_bfgs_b','max_iter_predict':100,'n_restarts_optimizer':2,'copy_X_train':True,}),
              ("{'optimizer':'fmin_l_bfgs_b','max_iter_predict':1,'n_restarts_optimizer':0,'copy_X_train':True,}", {'optimizer':'fmin_l_bfgs_b','max_iter_predict':1,'n_restarts_optimizer':0,'copy_X_train':True,}),
              ("{'optimizer':'fmin_l_bfgs_b','max_iter_predict':199,'n_restarts_optimizer':0,'copy_X_train':True,}", {'optimizer':'fmin_l_bfgs_b','max_iter_predict':199,'n_restarts_optimizer':0,'copy_X_train':True,}),
              ("{'optimizer':'fmin_l_bfgs_b','max_iter_predict':100,'n_restarts_optimizer':0,'copy_X_train':False,}", {'optimizer':'fmin_l_bfgs_b','max_iter_predict':100,'n_restarts_optimizer':0,'copy_X_train':False,}),
             ]
