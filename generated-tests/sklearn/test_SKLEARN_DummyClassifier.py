...
class test_SKLEARN_DummyClassifier(unittest.TestCase):

    params = [("{'constant':0,'strategy':'stratified',}", {'constant':0,'strategy':'stratified',}),
              ("{'constant':0,'strategy':'most_frequent',}", {'constant':0,'strategy':'most_frequent',}),
              ("{'constant':0,'strategy':'prior',}", {'constant':0,'strategy':'prior',}),
              ("{'constant':0,'strategy':'uniform',}", {'constant':0,'strategy':'uniform',}),
              ("{'constant':0,'strategy':'constant',}", {'constant':0,'strategy':'constant',}),
              ("{'constant':1,'strategy':'stratified',}", {'constant':1,'strategy':'stratified',}),
             ]
