...
class test_SKLEARN_BernoulliNB(unittest.TestCase):

    params = [("{'fit_prior':True,'alpha':0.0,'binarize':0.0,}", {'fit_prior':True,'alpha':0.0,'binarize':0.0,}),
              ("{'fit_prior':True,'alpha':0.5,'binarize':0.0,}", {'fit_prior':True,'alpha':0.5,'binarize':0.0,}),
              ("{'fit_prior':True,'alpha':1.0,'binarize':0.0,}", {'fit_prior':True,'alpha':1.0,'binarize':0.0,}),
              ("{'fit_prior':True,'alpha':1.5,'binarize':0.0,}", {'fit_prior':True,'alpha':1.5,'binarize':0.0,}),
              ("{'fit_prior':True,'alpha':1.0,'binarize':0.5,}", {'fit_prior':True,'alpha':1.0,'binarize':0.5,}),
              ("{'fit_prior':True,'alpha':1.0,'binarize':1.0,}", {'fit_prior':True,'alpha':1.0,'binarize':1.0,}),
              ("{'fit_prior':True,'alpha':1.0,'binarize':1.5,}", {'fit_prior':True,'alpha':1.0,'binarize':1.5,}),
              ("{'fit_prior':False,'alpha':1.0,'binarize':0.0,}", {'fit_prior':False,'alpha':1.0,'binarize':0.0,}),
             ]
