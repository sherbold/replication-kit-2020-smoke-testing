...
class test_SKLEARN_AgglomerativeClusteringWardNClusters(unittest.TestCase):

    params = [("{'n_clusters':2,'compute_full_tree':'auto',}", {'n_clusters':2,'compute_full_tree':'auto',}),
              ("{'n_clusters':3,'compute_full_tree':'auto',}", {'n_clusters':3,'compute_full_tree':'auto',}),
              ("{'n_clusters':4,'compute_full_tree':'auto',}", {'n_clusters':4,'compute_full_tree':'auto',}),
              ("{'n_clusters':2,'compute_full_tree':True,}", {'n_clusters':2,'compute_full_tree':True,}),
              ("{'n_clusters':2,'compute_full_tree':False,}", {'n_clusters':2,'compute_full_tree':False,}),
             ]
