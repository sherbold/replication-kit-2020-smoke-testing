...
class test_SKLEARN_MeanShift(unittest.TestCase):

    params = [("{'cluster_all':True,'n_jobs':None,'max_iter':300,'bin_seeding':True,}", {'cluster_all':True,'n_jobs':None,'max_iter':300,'bin_seeding':True,}),
              ("{'cluster_all':True,'n_jobs':None,'max_iter':300,'bin_seeding':False,}", {'cluster_all':True,'n_jobs':None,'max_iter':300,'bin_seeding':False,}),
              ("{'cluster_all':False,'n_jobs':None,'max_iter':300,'bin_seeding':False,}", {'cluster_all':False,'n_jobs':None,'max_iter':300,'bin_seeding':False,}),
              ("{'cluster_all':True,'n_jobs':-1,'max_iter':300,'bin_seeding':False,}", {'cluster_all':True,'n_jobs':-1,'max_iter':300,'bin_seeding':False,}),
              ("{'cluster_all':True,'n_jobs':2,'max_iter':300,'bin_seeding':False,}", {'cluster_all':True,'n_jobs':2,'max_iter':300,'bin_seeding':False,}),
              ("{'cluster_all':True,'n_jobs':None,'max_iter':200,'bin_seeding':False,}", {'cluster_all':True,'n_jobs':None,'max_iter':200,'bin_seeding':False,}),
              ("{'cluster_all':True,'n_jobs':None,'max_iter':400,'bin_seeding':False,}", {'cluster_all':True,'n_jobs':None,'max_iter':400,'bin_seeding':False,}),
             ]
