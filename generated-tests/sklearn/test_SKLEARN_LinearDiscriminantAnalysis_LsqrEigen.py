...
class test_SKLEARN_LinearDiscriminantAnalysis_LsqrEigen(unittest.TestCase):

    params = [("{'n_components':None,'tol':0.0001,'store_covariance':False,'shrinkage':None,'solver':'lsqr',}", {'n_components':None,'tol':0.0001,'store_covariance':False,'shrinkage':None,'solver':'lsqr',}),
              ("{'n_components':None,'tol':0.0001,'store_covariance':False,'shrinkage':None,'solver':'eigen',}", {'n_components':None,'tol':0.0001,'store_covariance':False,'shrinkage':None,'solver':'eigen',}),
              ("{'n_components':None,'tol':0.0001,'store_covariance':False,'shrinkage':'auto','solver':'lsqr',}", {'n_components':None,'tol':0.0001,'store_covariance':False,'shrinkage':'auto','solver':'lsqr',}),
              ("{'n_components':None,'tol':0.0001,'store_covariance':False,'shrinkage':0.1,'solver':'lsqr',}", {'n_components':None,'tol':0.0001,'store_covariance':False,'shrinkage':0.1,'solver':'lsqr',}),
              ("{'n_components':None,'tol':0.0001,'store_covariance':False,'shrinkage':0.5,'solver':'lsqr',}", {'n_components':None,'tol':0.0001,'store_covariance':False,'shrinkage':0.5,'solver':'lsqr',}),
              ("{'n_components':None,'tol':0.0001,'store_covariance':False,'shrinkage':0.9,'solver':'lsqr',}", {'n_components':None,'tol':0.0001,'store_covariance':False,'shrinkage':0.9,'solver':'lsqr',}),
              ("{'n_components':1,'tol':0.0001,'store_covariance':False,'shrinkage':None,'solver':'lsqr',}", {'n_components':1,'tol':0.0001,'store_covariance':False,'shrinkage':None,'solver':'lsqr',}),
              ("{'n_components':None,'tol':0.0001,'store_covariance':True,'shrinkage':None,'solver':'lsqr',}", {'n_components':None,'tol':0.0001,'store_covariance':True,'shrinkage':None,'solver':'lsqr',}),
             ]
