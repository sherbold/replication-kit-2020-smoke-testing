...
class test_SKLEARN_AffinityPropagation(unittest.TestCase):

    params = [("{'convergence_iter':15,'preference':None,'damping':0.5,'copy':True,'max_iter':200,'affinity':'euclidean','verbose':False,}", {'convergence_iter':15,'preference':None,'damping':0.5,'copy':True,'max_iter':200,'affinity':'euclidean','verbose':False,}),
              ("{'convergence_iter':15,'preference':None,'damping':0.9,'copy':True,'max_iter':200,'affinity':'euclidean','verbose':False,}", {'convergence_iter':15,'preference':None,'damping':0.9,'copy':True,'max_iter':200,'affinity':'euclidean','verbose':False,}),
              ("{'convergence_iter':15,'preference':None,'damping':0.5,'copy':True,'max_iter':50,'affinity':'euclidean','verbose':False,}", {'convergence_iter':15,'preference':None,'damping':0.5,'copy':True,'max_iter':50,'affinity':'euclidean','verbose':False,}),
              ("{'convergence_iter':15,'preference':None,'damping':0.5,'copy':True,'max_iter':350,'affinity':'euclidean','verbose':False,}", {'convergence_iter':15,'preference':None,'damping':0.5,'copy':True,'max_iter':350,'affinity':'euclidean','verbose':False,}),
              ("{'convergence_iter':1,'preference':None,'damping':0.5,'copy':True,'max_iter':200,'affinity':'euclidean','verbose':False,}", {'convergence_iter':1,'preference':None,'damping':0.5,'copy':True,'max_iter':200,'affinity':'euclidean','verbose':False,}),
              ("{'convergence_iter':29,'preference':None,'damping':0.5,'copy':True,'max_iter':200,'affinity':'euclidean','verbose':False,}", {'convergence_iter':29,'preference':None,'damping':0.5,'copy':True,'max_iter':200,'affinity':'euclidean','verbose':False,}),
              ("{'convergence_iter':15,'preference':None,'damping':0.5,'copy':False,'max_iter':200,'affinity':'euclidean','verbose':False,}", {'convergence_iter':15,'preference':None,'damping':0.5,'copy':False,'max_iter':200,'affinity':'euclidean','verbose':False,}),
              ("{'convergence_iter':15,'preference':1.0,'damping':0.5,'copy':True,'max_iter':200,'affinity':'euclidean','verbose':False,}", {'convergence_iter':15,'preference':1.0,'damping':0.5,'copy':True,'max_iter':200,'affinity':'euclidean','verbose':False,}),
              ("{'convergence_iter':15,'preference':None,'damping':0.5,'copy':True,'max_iter':200,'affinity':'precomputed','verbose':False,}", {'convergence_iter':15,'preference':None,'damping':0.5,'copy':True,'max_iter':200,'affinity':'precomputed','verbose':False,}),
              ("{'convergence_iter':15,'preference':None,'damping':0.5,'copy':True,'max_iter':200,'affinity':'euclidean','verbose':True,}", {'convergence_iter':15,'preference':None,'damping':0.5,'copy':True,'max_iter':200,'affinity':'euclidean','verbose':True,}),
             ]
