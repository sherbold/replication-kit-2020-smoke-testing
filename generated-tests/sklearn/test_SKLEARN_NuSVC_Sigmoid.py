...
class test_SKLEARN_NuSVC_Sigmoid(unittest.TestCase):

    params = [("{'tol':0.001,'shrinking':True,'coef0':0.0,'kernel':'sigmoid','probability':False,'nu':0.1,'gamma':'scale',}", {'tol':0.001,'shrinking':True,'coef0':0.0,'kernel':'sigmoid','probability':False,'nu':0.1,'gamma':'scale',}),
              ("{'tol':0.001,'shrinking':True,'coef0':0.0,'kernel':'sigmoid','probability':False,'nu':0.4,'gamma':'scale',}", {'tol':0.001,'shrinking':True,'coef0':0.0,'kernel':'sigmoid','probability':False,'nu':0.4,'gamma':'scale',}),
              ("{'tol':0.001,'shrinking':True,'coef0':0.0,'kernel':'sigmoid','probability':False,'nu':0.7,'gamma':'scale',}", {'tol':0.001,'shrinking':True,'coef0':0.0,'kernel':'sigmoid','probability':False,'nu':0.7,'gamma':'scale',}),
              ("{'tol':0.001,'shrinking':True,'coef0':0.0,'kernel':'sigmoid','probability':False,'nu':0.5,'gamma':'scale',}", {'tol':0.001,'shrinking':True,'coef0':0.0,'kernel':'sigmoid','probability':False,'nu':0.5,'gamma':'scale',}),
              ("{'tol':0.001,'shrinking':True,'coef0':0.0,'kernel':'sigmoid','probability':False,'nu':0.5,'gamma':'auto',}", {'tol':0.001,'shrinking':True,'coef0':0.0,'kernel':'sigmoid','probability':False,'nu':0.5,'gamma':'auto',}),
              ("{'tol':0.001,'shrinking':True,'coef0':0.0,'kernel':'sigmoid','probability':False,'nu':0.5,'gamma':0.1,}", {'tol':0.001,'shrinking':True,'coef0':0.0,'kernel':'sigmoid','probability':False,'nu':0.5,'gamma':0.1,}),
              ("{'tol':0.001,'shrinking':True,'coef0':0.5,'kernel':'sigmoid','probability':False,'nu':0.5,'gamma':'scale',}", {'tol':0.001,'shrinking':True,'coef0':0.5,'kernel':'sigmoid','probability':False,'nu':0.5,'gamma':'scale',}),
              ("{'tol':0.001,'shrinking':True,'coef0':1.0,'kernel':'sigmoid','probability':False,'nu':0.5,'gamma':'scale',}", {'tol':0.001,'shrinking':True,'coef0':1.0,'kernel':'sigmoid','probability':False,'nu':0.5,'gamma':'scale',}),
              ("{'tol':0.001,'shrinking':True,'coef0':1.5,'kernel':'sigmoid','probability':False,'nu':0.5,'gamma':'scale',}", {'tol':0.001,'shrinking':True,'coef0':1.5,'kernel':'sigmoid','probability':False,'nu':0.5,'gamma':'scale',}),
              ("{'tol':0.001,'shrinking':False,'coef0':0.0,'kernel':'sigmoid','probability':False,'nu':0.5,'gamma':'scale',}", {'tol':0.001,'shrinking':False,'coef0':0.0,'kernel':'sigmoid','probability':False,'nu':0.5,'gamma':'scale',}),
              ("{'tol':0.001,'shrinking':True,'coef0':0.0,'kernel':'sigmoid','probability':True,'nu':0.5,'gamma':'scale',}", {'tol':0.001,'shrinking':True,'coef0':0.0,'kernel':'sigmoid','probability':True,'nu':0.5,'gamma':'scale',}),
             ]
