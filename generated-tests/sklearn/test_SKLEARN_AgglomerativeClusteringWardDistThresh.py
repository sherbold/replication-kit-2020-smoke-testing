...
class test_SKLEARN_AgglomerativeClusteringWardDistThresh(unittest.TestCase):

    params = [("{'n_clusters':None,'distance_threshold':0.1,}", {'n_clusters':None,'distance_threshold':0.1,}),
              ("{'n_clusters':None,'distance_threshold':2.0,}", {'n_clusters':None,'distance_threshold':2.0,}),
              ("{'n_clusters':None,'distance_threshold':5.0,}", {'n_clusters':None,'distance_threshold':5.0,}),
             ]
