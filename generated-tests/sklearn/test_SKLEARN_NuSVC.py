...
class test_SKLEARN_NuSVC(unittest.TestCase):

    params = [("{'tol':0.001,'shrinking':True,'kernel':'rbf','probability':False,'nu':0.1,'gamma':'scale',}", {'tol':0.001,'shrinking':True,'kernel':'rbf','probability':False,'nu':0.1,'gamma':'scale',}),
              ("{'tol':0.001,'shrinking':True,'kernel':'rbf','probability':False,'nu':0.4,'gamma':'scale',}", {'tol':0.001,'shrinking':True,'kernel':'rbf','probability':False,'nu':0.4,'gamma':'scale',}),
              ("{'tol':0.001,'shrinking':True,'kernel':'rbf','probability':False,'nu':0.7,'gamma':'scale',}", {'tol':0.001,'shrinking':True,'kernel':'rbf','probability':False,'nu':0.7,'gamma':'scale',}),
              ("{'tol':0.001,'shrinking':True,'kernel':'linear','probability':False,'nu':0.5,'gamma':'scale',}", {'tol':0.001,'shrinking':True,'kernel':'linear','probability':False,'nu':0.5,'gamma':'scale',}),
              ("{'tol':0.001,'shrinking':True,'kernel':'rbf','probability':False,'nu':0.5,'gamma':'scale',}", {'tol':0.001,'shrinking':True,'kernel':'rbf','probability':False,'nu':0.5,'gamma':'scale',}),
              ("{'tol':0.001,'shrinking':True,'kernel':'rbf','probability':False,'nu':0.5,'gamma':'auto',}", {'tol':0.001,'shrinking':True,'kernel':'rbf','probability':False,'nu':0.5,'gamma':'auto',}),
              ("{'tol':0.001,'shrinking':True,'kernel':'rbf','probability':False,'nu':0.5,'gamma':0.1,}", {'tol':0.001,'shrinking':True,'kernel':'rbf','probability':False,'nu':0.5,'gamma':0.1,}),
              ("{'tol':0.001,'shrinking':False,'kernel':'rbf','probability':False,'nu':0.5,'gamma':'scale',}", {'tol':0.001,'shrinking':False,'kernel':'rbf','probability':False,'nu':0.5,'gamma':'scale',}),
              ("{'tol':0.001,'shrinking':True,'kernel':'rbf','probability':True,'nu':0.5,'gamma':'scale',}", {'tol':0.001,'shrinking':True,'kernel':'rbf','probability':True,'nu':0.5,'gamma':'scale',}),
             ]
