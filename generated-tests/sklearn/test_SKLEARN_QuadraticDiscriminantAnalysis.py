...
class test_SKLEARN_QuadraticDiscriminantAnalysis(unittest.TestCase):

    params = [("{'tol':0.0001,'reg_param':0.0,'store_covariance':False,}", {'tol':0.0001,'reg_param':0.0,'store_covariance':False,}),
              ("{'tol':0.0001,'reg_param':0.5,'store_covariance':False,}", {'tol':0.0001,'reg_param':0.5,'store_covariance':False,}),
              ("{'tol':0.0001,'reg_param':1.0,'store_covariance':False,}", {'tol':0.0001,'reg_param':1.0,'store_covariance':False,}),
              ("{'tol':0.0001,'reg_param':0.0,'store_covariance':True,}", {'tol':0.0001,'reg_param':0.0,'store_covariance':True,}),
             ]
