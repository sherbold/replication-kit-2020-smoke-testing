...
public class WEKA_PART_REP_AtomlTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            { new String[]{"-B","-R","-M","2","-N","3"}, "-B -R -M 2 -N 3"},
            { new String[]{"-R","-M","2","-N","3"}, "-R -M 2 -N 3"},
            { new String[]{"-R","-M","2","-doNotMakeSplitPointActualValue","-N","3"}, "-R -M 2 -doNotMakeSplitPointActualValue -N 3"},
            { new String[]{"-R","-M","1","-N","3"}, "-R -M 1 -N 3"},
            { new String[]{"-R","-M","3","-N","3"}, "-R -M 3 -N 3"},
