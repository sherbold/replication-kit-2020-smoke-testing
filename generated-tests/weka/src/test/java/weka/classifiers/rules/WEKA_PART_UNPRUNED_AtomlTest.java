...
public class WEKA_PART_UNPRUNED_AtomlTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            { new String[]{"-B","-C","0.25","-U","-M","2"}, "-B -C 0.25 -U -M 2"},
            { new String[]{"-C","0.25","-U","-M","2"}, "-C 0.25 -U -M 2"},
            { new String[]{"-C","0.01","-U","-M","2"}, "-C 0.01 -U -M 2"},
            { new String[]{"-C","0.13","-U","-M","2"}, "-C 0.13 -U -M 2"},
            { new String[]{"-C","0.25","-U","-M","2","-doNotMakeSplitPointActualValue"}, "-C 0.25 -U -M 2 -doNotMakeSplitPointActualValue"},
            { new String[]{"-C","0.25","-U","-M","1"}, "-C 0.25 -U -M 1"},
            { new String[]{"-C","0.25","-U","-M","3"}, "-C 0.25 -U -M 3"},
            { new String[]{"-C","0.25","-U","-J","-M","2"}, "-C 0.25 -U -J -M 2"}
           });
    }
    ...
    public void test_Uniform() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            Classifier classifier = AbstractClassifier.forName("weka.classifiers.rules.PART", Arrays.copyOf(parameters, parameters.length));
