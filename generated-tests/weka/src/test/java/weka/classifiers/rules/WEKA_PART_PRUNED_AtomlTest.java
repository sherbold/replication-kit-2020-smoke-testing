...
public class WEKA_PART_PRUNED_AtomlTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            { new String[]{"-B","-M","2"}, "-B -M 2"},
            { new String[]{"-M","2"}, "-M 2"},
            { new String[]{"-M","2","-doNotMakeSplitPointActualValue"}, "-M 2 -doNotMakeSplitPointActualValue"},
            { new String[]{"-M","1"}, "-M 1"},
            { new String[]{"-M","3"}, "-M 3"},
            { new String[]{"-J","-M","2"}, "-J -M 2"}
           });
    }
