...
public class WEKA_DECISIONTABLE_AtomlTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            { new String[]{"-S","weka.attributeSelection.BestFirst -D 1 -N 5","-E","-X","1"}, "-S weka.attributeSelection.BestFirst -D 1 -N 5 -E -X 1"},
            { new String[]{"-S","weka.attributeSelection.BestFirst -D 1 -N 5","-E","-X","2"}, "-S weka.attributeSelection.BestFirst -D 1 -N 5 -E -X 2"},
            { new String[]{"-S","weka.attributeSelection.BestFirst -D 1 -N 5","-E","-X","3"}, "-S weka.attributeSelection.BestFirst -D 1 -N 5 -E -X 3"},
            { new String[]{"-S","weka.attributeSelection.BestFirst -D 1 -N 5","-E","acc","-X","1"}, "-S weka.attributeSelection.BestFirst -D 1 -N 5 -E acc -X 1"},
            { new String[]{"-S","weka.attributeSelection.BestFirst -D 1 -N 5","-E","rmse","-X","1"}, "-S weka.attributeSelection.BestFirst -D 1 -N 5 -E rmse -X 1"},
            { new String[]{"-S","weka.attributeSelection.BestFirst -D 1 -N 5","-E","mae","-X","1"}, "-S weka.attributeSelection.BestFirst -D 1 -N 5 -E mae -X 1"},
            { new String[]{"-S","weka.attributeSelection.BestFirst -D 1 -N 5","-E","auc","-X","1"}, "-S weka.attributeSelection.BestFirst -D 1 -N 5 -E auc -X 1"},
            { new String[]{"-S","weka.attributeSelection.BestFirst -D 1 -N 5","-E","-X","1","-I"}, "-S weka.attributeSelection.BestFirst -D 1 -N 5 -E -X 1 -I"},
            { new String[]{"-S","weka.attributeSelection.GreedyStepwise -T -1.7976931348623157E308 -N -1 -num-slots 1","-E","-X","1"}, "-S weka.attributeSelection.GreedyStepwise -T -1.7976931348623157E308 -N -1 -num-slots 1 -E -X 1"}
           });
    }
    ...
    public void test_Uniform() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            Classifier classifier = AbstractClassifier.forName("weka.classifiers.rules.DecisionTable", Arrays.copyOf(parameters, parameters.length));
