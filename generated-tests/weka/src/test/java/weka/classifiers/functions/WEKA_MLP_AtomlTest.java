...
public class WEKA_MLP_AtomlTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            { new String[]{"-D","-E","20","-V","0","-H","a","-L","0.3","-M","0.2","-N","500"}, "-D -E 20 -V 0 -H a -L 0.3 -M 0.2 -N 500"},
            { new String[]{"-E","20","-V","0","-H","a","-L","0.3","-M","0.2","-N","500"}, "-E 20 -V 0 -H a -L 0.3 -M 0.2 -N 500"},
            { new String[]{"-E","20","-V","0","-H","i","-L","0.3","-M","0.2","-N","500"}, "-E 20 -V 0 -H i -L 0.3 -M 0.2 -N 500"},
            { new String[]{"-E","20","-V","0","-H","o","-L","0.3","-M","0.2","-N","500"}, "-E 20 -V 0 -H o -L 0.3 -M 0.2 -N 500"},
            { new String[]{"-E","20","-V","0","-H","t","-L","0.3","-M","0.2","-N","500"}, "-E 20 -V 0 -H t -L 0.3 -M 0.2 -N 500"},
            { new String[]{"-E","20","-V","0","-H","1","-L","0.3","-M","0.2","-N","500"}, "-E 20 -V 0 -H 1 -L 0.3 -M 0.2 -N 500"},
            { new String[]{"-E","20","-V","0","-H","2","-L","0.3","-M","0.2","-N","500"}, "-E 20 -V 0 -H 2 -L 0.3 -M 0.2 -N 500"},
            { new String[]{"-E","20","-V","0","-H","3","-L","0.3","-M","0.2","-N","500"}, "-E 20 -V 0 -H 3 -L 0.3 -M 0.2 -N 500"},
            { new String[]{"-E","20","-V","0","-H","a","-L","0.001","-M","0.2","-N","500"}, "-E 20 -V 0 -H a -L 0.001 -M 0.2 -N 500"},
            { new String[]{"-E","20","-V","0","-H","a","-L","0.01","-M","0.2","-N","500"}, "-E 20 -V 0 -H a -L 0.01 -M 0.2 -N 500"},
            { new String[]{"-E","20","-V","0","-H","a","-L","0.1","-M","0.2","-N","500"}, "-E 20 -V 0 -H a -L 0.1 -M 0.2 -N 500"},
            { new String[]{"-E","20","-V","0","-H","a","-L","0.3","-M","0.001","-N","500"}, "-E 20 -V 0 -H a -L 0.3 -M 0.001 -N 500"},
            { new String[]{"-E","20","-V","0","-H","a","-L","0.3","-M","0.01","-N","500"}, "-E 20 -V 0 -H a -L 0.3 -M 0.01 -N 500"},
            { new String[]{"-E","20","-V","0","-H","a","-L","0.3","-M","0.1","-N","500"}, "-E 20 -V 0 -H a -L 0.3 -M 0.1 -N 500"},
            { new String[]{"-B","-E","20","-V","0","-H","a","-L","0.3","-M","0.2","-N","500"}, "-B -E 20 -V 0 -H a -L 0.3 -M 0.2 -N 500"},
            { new String[]{"-E","20","-V","0","-H","a","-I","-L","0.3","-M","0.2","-N","500"}, "-E 20 -V 0 -H a -I -L 0.3 -M 0.2 -N 500"},
            { new String[]{"-C","-E","20","-V","0","-H","a","-L","0.3","-M","0.2","-N","500"}, "-C -E 20 -V 0 -H a -L 0.3 -M 0.2 -N 500"},
            { new String[]{"-R","-E","20","-V","0","-H","a","-L","0.3","-M","0.2","-N","500"}, "-R -E 20 -V 0 -H a -L 0.3 -M 0.2 -N 500"},
            { new String[]{"-E","20","-V","0","-H","a","-L","0.3","-M","0.2","-N","100"}, "-E 20 -V 0 -H a -L 0.3 -M 0.2 -N 100"},
            { new String[]{"-E","20","-V","0","-H","a","-L","0.3","-M","0.2","-N","900"}, "-E 20 -V 0 -H a -L 0.3 -M 0.2 -N 900"},
            { new String[]{"-E","20","-V","45","-H","a","-L","0.3","-M","0.2","-N","500"}, "-E 20 -V 45 -H a -L 0.3 -M 0.2 -N 500"},
            { new String[]{"-E","20","-V","90","-H","a","-L","0.3","-M","0.2","-N","500"}, "-E 20 -V 90 -H a -L 0.3 -M 0.2 -N 500"},
            { new String[]{"-E","1","-V","0","-H","a","-L","0.3","-M","0.2","-N","500"}, "-E 1 -V 0 -H a -L 0.3 -M 0.2 -N 500"},
            { new String[]{"-E","39","-V","0","-H","a","-L","0.3","-M","0.2","-N","500"}, "-E 39 -V 0 -H a -L 0.3 -M 0.2 -N 500"}
           });
    }
    ...
    public void test_Uniform() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            Classifier classifier = AbstractClassifier.forName("weka.classifiers.functions.MultilayerPerceptron", Arrays.copyOf(parameters, parameters.length));
