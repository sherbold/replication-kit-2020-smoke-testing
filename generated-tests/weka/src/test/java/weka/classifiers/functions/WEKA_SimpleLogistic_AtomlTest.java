...
public class WEKA_SimpleLogistic_AtomlTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            { new String[]{"-P","-W","0.0","-H","50","-I","0","-M","500"}, "-P -W 0.0 -H 50 -I 0 -M 500"},
            { new String[]{"-W","0.0","-H","50","-I","0","-M","500"}, "-W 0.0 -H 50 -I 0 -M 500"},
            { new String[]{"-W","0.0","-H","0","-I","0","-M","500"}, "-W 0.0 -H 0 -I 0 -M 500"},
            { new String[]{"-W","0.0","-H","100","-I","0","-M","500"}, "-W 0.0 -H 100 -I 0 -M 500"},
            { new String[]{"-W","0.0","-H","50","-I","0","-M","1"}, "-W 0.0 -H 50 -I 0 -M 1"},
            { new String[]{"-W","0.0","-H","50","-I","0","-M","999"}, "-W 0.0 -H 50 -I 0 -M 999"},
            { new String[]{"-W","0.0","-H","50","-I","500","-M","500"}, "-W 0.0 -H 50 -I 500 -M 500"},
            { new String[]{"-W","0.0","-H","50","-I","1000","-M","500"}, "-W 0.0 -H 50 -I 1000 -M 500"},
            { new String[]{"-A","-W","0.0","-H","50","-I","0","-M","500"}, "-A -W 0.0 -H 50 -I 0 -M 500"},
            { new String[]{"-S","-W","0.0","-H","50","-I","0","-M","500"}, "-S -W 0.0 -H 50 -I 0 -M 500"},
            { new String[]{"-W","0.45","-H","50","-I","0","-M","500"}, "-W 0.45 -H 50 -I 0 -M 500"},
            { new String[]{"-W","0.90","-H","50","-I","0","-M","500"}, "-W 0.90 -H 50 -I 0 -M 500"}
           });
    }
    ...
    public void test_Uniform() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            Classifier classifier = AbstractClassifier.forName("weka.classifiers.functions.SimpleLogistic", Arrays.copyOf(parameters, parameters.length));
