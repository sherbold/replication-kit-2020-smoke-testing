...
public class WEKA_SGD_AtomlTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            { new String[]{"-R","0.0001","-C","0.001","-E","500","-F","0","-L","0.3","-N"}, "-R 0.0001 -C 0.001 -E 500 -F 0 -L 0.3 -N"},
            { new String[]{"-R","0.0001","-C","0.001","-E","500","-F","0","-L","0.3"}, "-R 0.0001 -C 0.001 -E 500 -F 0 -L 0.3"},
            { new String[]{"-R","0.0001","-C","0.001","-E","100","-F","0","-L","0.3"}, "-R 0.0001 -C 0.001 -E 100 -F 0 -L 0.3"},
            { new String[]{"-R","0.0001","-C","0.001","-E","900","-F","0","-L","0.3"}, "-R 0.0001 -C 0.001 -E 900 -F 0 -L 0.3"},
            { new String[]{"-R","0.0001","-C","0.0001","-E","500","-F","0","-L","0.3"}, "-R 0.0001 -C 0.0001 -E 500 -F 0 -L 0.3"},
            { new String[]{"-R","0.0001","-C","0.01","-E","500","-F","0","-L","0.3"}, "-R 0.0001 -C 0.01 -E 500 -F 0 -L 0.3"},
            { new String[]{"-R","0.00001","-C","0.001","-E","500","-F","0","-L","0.3"}, "-R 0.00001 -C 0.001 -E 500 -F 0 -L 0.3"},
            { new String[]{"-R","0.001","-C","0.001","-E","500","-F","0","-L","0.3"}, "-R 0.001 -C 0.001 -E 500 -F 0 -L 0.3"},
            { new String[]{"-R","0.0001","-C","0.001","-E","500","-F","0","-L","0.001"}, "-R 0.0001 -C 0.001 -E 500 -F 0 -L 0.001"},
            { new String[]{"-R","0.0001","-C","0.001","-E","500","-F","0","-L","0.01"}, "-R 0.0001 -C 0.001 -E 500 -F 0 -L 0.01"},
            { new String[]{"-R","0.0001","-C","0.001","-E","500","-F","0","-L","0.1"}, "-R 0.0001 -C 0.001 -E 500 -F 0 -L 0.1"},
            { new String[]{"-R","0.0001","-C","0.001","-E","500","-F","1","-L","0.3"}, "-R 0.0001 -C 0.001 -E 500 -F 1 -L 0.3"}
           });
    }
    ...
    public void test_Uniform() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            Classifier classifier = AbstractClassifier.forName("weka.classifiers.functions.SGD", Arrays.copyOf(parameters, parameters.length));
