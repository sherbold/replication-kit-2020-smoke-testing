...
public class WEKA_SVM_AtomlTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            { new String[]{"-P","1E-12","-C","1.0","-K","weka.classifiers.functions.supportVector.PolyKernel -E 1.0 -C 250007","-N","0"}, "-P 1E-12 -C 1.0 -K weka.classifiers.functions.supportVector.PolyKernel -E 1.0 -C 250007 -N 0"},
            { new String[]{"-P","1E-12","-C","1.0","-K","weka.classifiers.functions.supportVector.PolyKernel -E 1.0 -C 250007","-N","1"}, "-P 1E-12 -C 1.0 -K weka.classifiers.functions.supportVector.PolyKernel -E 1.0 -C 250007 -N 1"},
            { new String[]{"-P","1E-12","-C","1.0","-K","weka.classifiers.functions.supportVector.PolyKernel -E 1.0 -C 250007","-N","2"}, "-P 1E-12 -C 1.0 -K weka.classifiers.functions.supportVector.PolyKernel -E 1.0 -C 250007 -N 2"},
            { new String[]{"-P","1E-12","-C","0.5","-K","weka.classifiers.functions.supportVector.PolyKernel -E 1.0 -C 250007","-N","0"}, "-P 1E-12 -C 0.5 -K weka.classifiers.functions.supportVector.PolyKernel -E 1.0 -C 250007 -N 0"},
            { new String[]{"-P","1E-12","-C","1.5","-K","weka.classifiers.functions.supportVector.PolyKernel -E 1.0 -C 250007","-N","0"}, "-P 1E-12 -C 1.5 -K weka.classifiers.functions.supportVector.PolyKernel -E 1.0 -C 250007 -N 0"},
            { new String[]{"-P","1E-12","-C","1.0","-K","weka.classifiers.functions.supportVector.NormalizedPolyKernel -E 2.0 -C 250007","-N","0"}, "-P 1E-12 -C 1.0 -K weka.classifiers.functions.supportVector.NormalizedPolyKernel -E 2.0 -C 250007 -N 0"},
            { new String[]{"-P","1E-12","-C","1.0","-K","weka.classifiers.functions.supportVector.RBFKernel -C 250007 -G 0.01","-N","0"}, "-P 1E-12 -C 1.0 -K weka.classifiers.functions.supportVector.RBFKernel -C 250007 -G 0.01 -N 0"},
            { new String[]{"-P","1E-12","-C","1.0","-K","weka.classifiers.functions.supportVector.Puk -O 1.0 -S 1.0 -C 250007","-N","0"}, "-P 1E-12 -C 1.0 -K weka.classifiers.functions.supportVector.Puk -O 1.0 -S 1.0 -C 250007 -N 0"}
           });
    }
