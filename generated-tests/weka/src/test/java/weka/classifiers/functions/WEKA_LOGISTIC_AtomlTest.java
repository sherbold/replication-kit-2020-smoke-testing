...
public class WEKA_LOGISTIC_AtomlTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            { new String[]{"-R","1.0E-7"}, "-R 1.0E-7"},
            { new String[]{"-R","1.0E-8"}, "-R 1.0E-8"},
            { new String[]{"-R","1.0E-9"}, "-R 1.0E-9"},
            { new String[]{"-R","1.0E-8","-C"}, "-R 1.0E-8 -C"}
           });
    }
    ...
    public void test_Uniform() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            Classifier classifier = AbstractClassifier.forName("weka.classifiers.functions.Logistic", Arrays.copyOf(parameters, parameters.length));
