...
public class WEKA_BAYESNET_AtomlTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            { new String[]{"-Q","weka.classifiers.bayes.net.search.local.K2","-E","weka.classifiers.bayes.net.estimate.SimpleEstimator"}, "-Q weka.classifiers.bayes.net.search.local.K2 -E weka.classifiers.bayes.net.estimate.SimpleEstimator"},
            { new String[]{"-Q","weka.classifiers.bayes.net.search.local.K2","-E","weka.classifiers.bayes.net.estimate.BMAEstimator"}, "-Q weka.classifiers.bayes.net.search.local.K2 -E weka.classifiers.bayes.net.estimate.BMAEstimator"},
            { new String[]{"-Q","weka.classifiers.bayes.net.search.local.HillClimber","-E","weka.classifiers.bayes.net.estimate.SimpleEstimator"}, "-Q weka.classifiers.bayes.net.search.local.HillClimber -E weka.classifiers.bayes.net.estimate.SimpleEstimator"},
            { new String[]{"-Q","weka.classifiers.bayes.net.search.local.LAGDHillClimber","-E","weka.classifiers.bayes.net.estimate.SimpleEstimator"}, "-Q weka.classifiers.bayes.net.search.local.LAGDHillClimber -E weka.classifiers.bayes.net.estimate.SimpleEstimator"},
            { new String[]{"-Q","weka.classifiers.bayes.net.search.local.TabuSearch","-E","weka.classifiers.bayes.net.estimate.SimpleEstimator"}, "-Q weka.classifiers.bayes.net.search.local.TabuSearch -E weka.classifiers.bayes.net.estimate.SimpleEstimator"},
            { new String[]{"-Q","weka.classifiers.bayes.net.search.local.TAN","-E","weka.classifiers.bayes.net.estimate.SimpleEstimator"}, "-Q weka.classifiers.bayes.net.search.local.TAN -E weka.classifiers.bayes.net.estimate.SimpleEstimator"},
            { new String[]{"-Q","weka.classifiers.bayes.net.search.local.K2","-D","-E","weka.classifiers.bayes.net.estimate.SimpleEstimator"}, "-Q weka.classifiers.bayes.net.search.local.K2 -D -E weka.classifiers.bayes.net.estimate.SimpleEstimator"}
           });
    }
    ...
    public void test_Uniform() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            Classifier classifier = AbstractClassifier.forName("weka.classifiers.bayes.BayesNet", Arrays.copyOf(parameters, parameters.length));
