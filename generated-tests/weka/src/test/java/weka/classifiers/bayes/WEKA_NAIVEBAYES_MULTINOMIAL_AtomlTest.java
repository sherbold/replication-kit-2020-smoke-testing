...
public class WEKA_NAIVEBAYES_MULTINOMIAL_AtomlTest {
    ...
    public void test_Uniform() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            Classifier classifier = AbstractClassifier.forName("weka.classifiers.bayes.NaiveBayesMultinomial", Arrays.copyOf(parameters, parameters.length));
