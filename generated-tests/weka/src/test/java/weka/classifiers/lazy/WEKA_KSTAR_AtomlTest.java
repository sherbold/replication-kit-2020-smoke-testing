...
public class WEKA_KSTAR_AtomlTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            { new String[]{"-B","20","-E","-M","a"}, "-B 20 -E -M a"},
            { new String[]{"-B","20","-M","a"}, "-B 20 -M a"},
            { new String[]{"-B","10","-M","a"}, "-B 10 -M a"},
            { new String[]{"-B","30","-M","a"}, "-B 30 -M a"},
            { new String[]{"-B","20","-M","d"}, "-B 20 -M d"},
            { new String[]{"-B","20","-M","m"}, "-B 20 -M m"},
            { new String[]{"-B","20","-M","n"}, "-B 20 -M n"}
           });
    }
    ...
    public void test_Uniform() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            Classifier classifier = AbstractClassifier.forName("weka.classifiers.lazy.KStar", Arrays.copyOf(parameters, parameters.length));
