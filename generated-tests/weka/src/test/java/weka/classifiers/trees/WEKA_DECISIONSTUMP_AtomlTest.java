...
public class WEKA_DECISIONSTUMP_AtomlTest {
    ...
    public void test_Uniform() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            Classifier classifier = AbstractClassifier.forName("weka.classifiers.trees.DecisionStump", Arrays.copyOf(parameters, parameters.length));
