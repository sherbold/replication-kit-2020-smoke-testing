...
public class WEKA_C45_PRUNED_AtomlTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            { new String[]{"-C","0.05","-M","2"}, "-C 0.05 -M 2"},
            { new String[]{"-C","0.50","-M","2"}, "-C 0.50 -M 2"},
            { new String[]{"-C","0.95","-M","2"}, "-C 0.95 -M 2"},
            { new String[]{"-C","0.25","-M","1"}, "-C 0.25 -M 1"},
            { new String[]{"-C","0.25","-M","10"}, "-C 0.25 -M 10"},
            { new String[]{"-C","0.25","-M","2","-O"}, "-C 0.25 -M 2 -O"},
            { new String[]{"-C","0.25","-M","2"}, "-C 0.25 -M 2"},
            { new String[]{"-C","0.25","-M","2","-doNotMakeSplitPointActualValue"}, "-C 0.25 -M 2 -doNotMakeSplitPointActualValue"},
            { new String[]{"-C","0.25","-S","-M","2"}, "-C 0.25 -S -M 2"},
            { new String[]{"-A","-C","0.25","-M","2"}, "-A -C 0.25 -M 2"},
            { new String[]{"-C","0.25","-J","-M","2"}, "-C 0.25 -J -M 2"}
           });
    }
    ...
    public void test_Uniform() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            Classifier classifier = AbstractClassifier.forName("weka.classifiers.trees.J48", Arrays.copyOf(parameters, parameters.length));
