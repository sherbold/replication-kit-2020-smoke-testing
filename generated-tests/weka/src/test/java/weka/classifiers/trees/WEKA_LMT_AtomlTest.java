...
public class WEKA_LMT_AtomlTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            { new String[]{"-B","-C","-W","0.0","-I","-1","-M","15"}, "-B -C -W 0.0 -I -1 -M 15"},
            { new String[]{"-C","-W","0.0","-I","-1","-M","15"}, "-C -W 0.0 -I -1 -M 15"},
            { new String[]{"-C","-W","0.0","-I","-1","-M","15","-doNotMakeSplitPointActualValue"}, "-C -W 0.0 -I -1 -M 15 -doNotMakeSplitPointActualValue"},
            { new String[]{"-P","-C","-W","0.0","-I","-1","-M","15"}, "-P -C -W 0.0 -I -1 -M 15"},
            { new String[]{"-W","0.0","-I","-1","-M","15"}, "-W 0.0 -I -1 -M 15"},
            { new String[]{"-C","-W","0.0","-I","-1","-M","1"}, "-C -W 0.0 -I -1 -M 1"},
            { new String[]{"-C","-W","0.0","-I","-1","-M","29"}, "-C -W 0.0 -I -1 -M 29"},
            { new String[]{"-C","-W","0.0","-I","1","-M","15"}, "-C -W 0.0 -I 1 -M 15"},
            { new String[]{"-C","-W","0.0","-I","3","-M","15"}, "-C -W 0.0 -I 3 -M 15"},
            { new String[]{"-R","-C","-W","0.0","-I","-1","-M","15"}, "-R -C -W 0.0 -I -1 -M 15"},
            { new String[]{"-A","-C","-W","0.0","-I","-1","-M","15"}, "-A -C -W 0.0 -I -1 -M 15"},
            { new String[]{"-C","-W","0.5","-I","-1","-M","15"}, "-C -W 0.5 -I -1 -M 15"},
            { new String[]{"-C","-W","1.0","-I","-1","-M","15"}, "-C -W 1.0 -I -1 -M 15"}
           });
    }
    ...
    public void test_Uniform() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            Classifier classifier = AbstractClassifier.forName("weka.classifiers.trees.LMT", Arrays.copyOf(parameters, parameters.length));
