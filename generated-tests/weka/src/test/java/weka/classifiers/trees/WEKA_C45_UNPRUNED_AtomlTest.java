...
public class WEKA_C45_UNPRUNED_AtomlTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            { new String[]{"-U","-M","1"}, "-U -M 1"},
            { new String[]{"-U","-M","10"}, "-U -M 10"},
            { new String[]{"-U","-M","2","-O"}, "-U -M 2 -O"},
            { new String[]{"-U","-M","2"}, "-U -M 2"},
            { new String[]{"-U","-M","2","-doNotMakeSplitPointActualValue"}, "-U -M 2 -doNotMakeSplitPointActualValue"},
            { new String[]{"-A","-U","-M","2"}, "-A -U -M 2"},
            { new String[]{"-U","-J","-M","2"}, "-U -J -M 2"}
           });
    }
