...
public class WEKA_C45_REP_AtomlTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            { new String[]{"-R","-M","2","-N","2"}, "-R -M 2 -N 2"},
            { new String[]{"-R","-M","2","-N","3"}, "-R -M 2 -N 3"},
            { new String[]{"-R","-M","2","-N","4"}, "-R -M 2 -N 4"},
            { new String[]{"-R","-M","1","-N","3"}, "-R -M 1 -N 3"},
            { new String[]{"-R","-M","10","-N","3"}, "-R -M 10 -N 3"},
            { new String[]{"-R","-M","2","-N","3","-O"}, "-R -M 2 -N 3 -O"},
            { new String[]{"-R","-M","2","-N","3","-doNotMakeSplitPointActualValue"}, "-R -M 2 -N 3 -doNotMakeSplitPointActualValue"},
            { new String[]{"-A","-R","-M","2","-N","3"}, "-A -R -M 2 -N 3"},
            { new String[]{"-R","-J","-M","2","-N","3"}, "-R -J -M 2 -N 3"}
           });
    }
