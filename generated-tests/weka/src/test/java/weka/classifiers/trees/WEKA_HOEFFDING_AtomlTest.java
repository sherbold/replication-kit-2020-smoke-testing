...
public class WEKA_HOEFFDING_AtomlTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            { new String[]{"-E","1.0E-7","-G","50","-H","0.05","-L","2","-M","0.01","-N","0.01"}, "-E 1.0E-7 -G 50 -H 0.05 -L 2 -M 0.01 -N 0.01"},
            { new String[]{"-E","1.0E-7","-G","200","-H","0.05","-L","2","-M","0.01","-N","0.01"}, "-E 1.0E-7 -G 200 -H 0.05 -L 2 -M 0.01 -N 0.01"},
            { new String[]{"-E","1.0E-7","-G","350","-H","0.05","-L","2","-M","0.01","-N","0.01"}, "-E 1.0E-7 -G 350 -H 0.05 -L 2 -M 0.01 -N 0.01"},
            { new String[]{"-E","1.0E-7","-G","200","-H","0.001","-L","2","-M","0.01","-N","0.01"}, "-E 1.0E-7 -G 200 -H 0.001 -L 2 -M 0.01 -N 0.01"},
            { new String[]{"-E","1.0E-7","-G","200","-H","0.1","-L","2","-M","0.01","-N","0.01"}, "-E 1.0E-7 -G 200 -H 0.1 -L 2 -M 0.01 -N 0.01"},
            { new String[]{"-E","1.0E-7","-G","200","-H","0.05","-L","0","-M","0.01","-N","0.01"}, "-E 1.0E-7 -G 200 -H 0.05 -L 0 -M 0.01 -N 0.01"},
            { new String[]{"-E","1.0E-7","-G","200","-H","0.05","-L","1","-M","0.01","-N","0.01"}, "-E 1.0E-7 -G 200 -H 0.05 -L 1 -M 0.01 -N 0.01"},
            { new String[]{"-E","1.0E-7","-G","200","-H","0.05","-L","2","-M","0.005","-N","0.01"}, "-E 1.0E-7 -G 200 -H 0.05 -L 2 -M 0.005 -N 0.01"},
            { new String[]{"-E","1.0E-7","-G","200","-H","0.05","-L","2","-M","0.010","-N","0.01"}, "-E 1.0E-7 -G 200 -H 0.05 -L 2 -M 0.010 -N 0.01"},
            { new String[]{"-E","1.0E-7","-G","200","-H","0.05","-L","2","-M","0.015","-N","0.01"}, "-E 1.0E-7 -G 200 -H 0.05 -L 2 -M 0.015 -N 0.01"},
            { new String[]{"-E","1.0E-7","-G","200","-H","0.05","-L","2","-M","0.01","-N","0.005"}, "-E 1.0E-7 -G 200 -H 0.05 -L 2 -M 0.01 -N 0.005"},
            { new String[]{"-E","1.0E-7","-G","200","-H","0.05","-L","2","-M","0.01","-N","0.010"}, "-E 1.0E-7 -G 200 -H 0.05 -L 2 -M 0.01 -N 0.010"},
            { new String[]{"-E","1.0E-7","-G","200","-H","0.05","-L","2","-M","0.01","-N","0.015"}, "-E 1.0E-7 -G 200 -H 0.05 -L 2 -M 0.01 -N 0.015"},
            { new String[]{"-E","1.0E-5","-G","200","-H","0.05","-L","2","-M","0.01","-N","0.01"}, "-E 1.0E-5 -G 200 -H 0.05 -L 2 -M 0.01 -N 0.01"},
            { new String[]{"-E","1.0E-3","-G","200","-H","0.05","-L","2","-M","0.01","-N","0.01"}, "-E 1.0E-3 -G 200 -H 0.05 -L 2 -M 0.01 -N 0.01"}
           });
    }
    ...
    public void test_Uniform() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            Classifier classifier = AbstractClassifier.forName("weka.classifiers.trees.HoeffdingTree", Arrays.copyOf(parameters, parameters.length));
