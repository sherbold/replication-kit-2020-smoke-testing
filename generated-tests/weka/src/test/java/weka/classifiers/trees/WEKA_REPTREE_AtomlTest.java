...
public class WEKA_REPTREE_AtomlTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            { new String[]{"-V","0.001","-I","0.0","-L","-1","-M","2","-N","3"}, "-V 0.001 -I 0.0 -L -1 -M 2 -N 3"},
            { new String[]{"-V","0.001","-I","1.0","-L","-1","-M","2","-N","3"}, "-V 0.001 -I 1.0 -L -1 -M 2 -N 3"},
            { new String[]{"-V","0.001","-I","2.0","-L","-1","-M","2","-N","3"}, "-V 0.001 -I 2.0 -L -1 -M 2 -N 3"},
            { new String[]{"-V","0.001","-I","0.0","-L","1","-M","2","-N","3"}, "-V 0.001 -I 0.0 -L 1 -M 2 -N 3"},
            { new String[]{"-V","0.001","-I","0.0","-L","3","-M","2","-N","3"}, "-V 0.001 -I 0.0 -L 3 -M 2 -N 3"},
            { new String[]{"-V","0.001","-I","0.0","-L","-1","-M","1","-N","3"}, "-V 0.001 -I 0.0 -L -1 -M 1 -N 3"},
            { new String[]{"-V","0.001","-I","0.0","-L","-1","-M","3","-N","3"}, "-V 0.001 -I 0.0 -L -1 -M 3 -N 3"},
            { new String[]{"-V","0.051","-I","0.0","-L","-1","-M","2","-N","3"}, "-V 0.051 -I 0.0 -L -1 -M 2 -N 3"},
            { new String[]{"-V","0.101","-I","0.0","-L","-1","-M","2","-N","3"}, "-V 0.101 -I 0.0 -L -1 -M 2 -N 3"},
            { new String[]{"-P","-V","0.001","-I","0.0","-L","-1","-M","2","-N","3"}, "-P -V 0.001 -I 0.0 -L -1 -M 2 -N 3"},
            { new String[]{"-V","0.001","-I","0.0","-L","-1","-M","2","-N","2"}, "-V 0.001 -I 0.0 -L -1 -M 2 -N 2"},
            { new String[]{"-V","0.001","-I","0.0","-L","-1","-M","2","-N","4"}, "-V 0.001 -I 0.0 -L -1 -M 2 -N 4"},
            { new String[]{"-R","-V","0.001","-I","0.0","-L","-1","-M","2","-N","3"}, "-R -V 0.001 -I 0.0 -L -1 -M 2 -N 3"}
           });
    }
    ...
    public void test_Uniform() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            Classifier classifier = AbstractClassifier.forName("weka.classifiers.trees.REPTree", Arrays.copyOf(parameters, parameters.length));
