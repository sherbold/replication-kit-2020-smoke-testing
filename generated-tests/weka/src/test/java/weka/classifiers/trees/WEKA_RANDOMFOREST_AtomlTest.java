...
public class WEKA_RANDOMFOREST_AtomlTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            { new String[]{"-B","-depth","0","-V","0.001","-num-slots","1","-I","100","-M","1.0","-N","0"}, "-B -depth 0 -V 0.001 -num-slots 1 -I 100 -M 1.0 -N 0"},
            { new String[]{"-depth","0","-V","0.001","-num-slots","1","-I","100","-M","1.0","-N","0"}, "-depth 0 -V 0.001 -num-slots 1 -I 100 -M 1.0 -N 0"},
            { new String[]{"-depth","0","-V","0.001","-num-slots","1","-I","100","-M","1.0","-N","0","-O"}, "-depth 0 -V 0.001 -num-slots 1 -I 100 -M 1.0 -N 0 -O"},
            { new String[]{"-depth","0","-attribute-importance","-V","0.001","-num-slots","1","-I","100","-M","1.0","-N","0"}, "-depth 0 -attribute-importance -V 0.001 -num-slots 1 -I 100 -M 1.0 -N 0"},
            { new String[]{"-depth","1","-V","0.001","-num-slots","1","-I","100","-M","1.0","-N","0"}, "-depth 1 -V 0.001 -num-slots 1 -I 100 -M 1.0 -N 0"},
            { new String[]{"-depth","2","-V","0.001","-num-slots","1","-I","100","-M","1.0","-N","0"}, "-depth 2 -V 0.001 -num-slots 1 -I 100 -M 1.0 -N 0"},
            { new String[]{"-depth","0","-V","0.001","-num-slots","2","-I","100","-M","1.0","-N","0"}, "-depth 0 -V 0.001 -num-slots 2 -I 100 -M 1.0 -N 0"},
            { new String[]{"-depth","0","-V","0.001","-num-slots","1","-I","10","-M","1.0","-N","0"}, "-depth 0 -V 0.001 -num-slots 1 -I 10 -M 1.0 -N 0"},
            { new String[]{"-depth","0","-V","0.001","-num-slots","1","-I","100","-M","5.0","-N","0"}, "-depth 0 -V 0.001 -num-slots 1 -I 100 -M 5.0 -N 0"},
            { new String[]{"-depth","0","-V","0.051","-num-slots","1","-I","100","-M","1.0","-N","0"}, "-depth 0 -V 0.051 -num-slots 1 -I 100 -M 1.0 -N 0"},
            { new String[]{"-depth","0","-V","0.101","-num-slots","1","-I","100","-M","1.0","-N","0"}, "-depth 0 -V 0.101 -num-slots 1 -I 100 -M 1.0 -N 0"}
           });
    }
    ...
    public void test_Uniform() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            Classifier classifier = AbstractClassifier.forName("weka.classifiers.trees.RandomForest", Arrays.copyOf(parameters, parameters.length));
