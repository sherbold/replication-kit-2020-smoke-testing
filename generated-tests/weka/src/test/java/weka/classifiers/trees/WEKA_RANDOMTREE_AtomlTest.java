...
public class WEKA_RANDOMTREE_AtomlTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            { new String[]{"-B","-depth","0","-V","0.001","-M","1.0","-N","0"}, "-B -depth 0 -V 0.001 -M 1.0 -N 0"},
            { new String[]{"-depth","0","-V","0.001","-M","1.0","-N","0"}, "-depth 0 -V 0.001 -M 1.0 -N 0"},
            { new String[]{"-depth","1","-V","0.001","-M","1.0","-N","0"}, "-depth 1 -V 0.001 -M 1.0 -N 0"},
            { new String[]{"-depth","2","-V","0.001","-M","1.0","-N","0"}, "-depth 2 -V 0.001 -M 1.0 -N 0"},
            { new String[]{"-depth","0","-V","0.001","-M","5.0","-N","0"}, "-depth 0 -V 0.001 -M 5.0 -N 0"},
            { new String[]{"-depth","0","-V","0.051","-M","1.0","-N","0"}, "-depth 0 -V 0.051 -M 1.0 -N 0"},
            { new String[]{"-depth","0","-V","0.101","-M","1.0","-N","0"}, "-depth 0 -V 0.101 -M 1.0 -N 0"},
            { new String[]{"-depth","0","-V","0.001","-M","1.0","-N","2"}, "-depth 0 -V 0.001 -M 1.0 -N 2"},
            { new String[]{"-depth","0","-V","0.001","-M","1.0","-N","4"}, "-depth 0 -V 0.001 -M 1.0 -N 4"}
           });
    }
    ...
    public void test_Uniform() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            Classifier classifier = AbstractClassifier.forName("weka.classifiers.trees.RandomTree", Arrays.copyOf(parameters, parameters.length));
