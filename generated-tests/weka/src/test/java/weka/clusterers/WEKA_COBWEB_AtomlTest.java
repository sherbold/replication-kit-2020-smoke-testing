...
public class WEKA_COBWEB_AtomlTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            { new String[]{"-A","0.5","-C","0.0028"}, "-A 0.5 -C 0.0028"},
            { new String[]{"-A","1.0","-C","0.0028"}, "-A 1.0 -C 0.0028"},
            { new String[]{"-A","1.5","-C","0.0028"}, "-A 1.5 -C 0.0028"},
            { new String[]{"-A","1.0","-C","0.001"}, "-A 1.0 -C 0.001"},
            { new String[]{"-A","1.0","-C","0.006"}, "-A 1.0 -C 0.006"},
            { new String[]{"-A","1.0","-C","0.011"}, "-A 1.0 -C 0.011"},
            { new String[]{"-A","1.0","-C","0.0028","-save-data"}, "-A 1.0 -C 0.0028 -save-data"}
           });
    }
    ...
    public void test_Uniform() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            Clusterer clusterer = AbstractClusterer.forName("weka.clusterers.Cobweb", Arrays.copyOf(parameters, parameters.length));
