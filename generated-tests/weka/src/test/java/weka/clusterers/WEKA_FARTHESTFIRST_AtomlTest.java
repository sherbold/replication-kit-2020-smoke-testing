...
public class WEKA_FARTHESTFIRST_AtomlTest {
    ...
    public void test_Uniform() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            Clusterer clusterer = AbstractClusterer.forName("weka.clusterers.FarthestFirst", Arrays.copyOf(parameters, parameters.length));
