...
public class WEKA_CANOPY_AtomlTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
            { new String[]{"-periodic-pruning","300","-min-density","2.0","-max-candidates","100","-t1","-1.25","-N","2","-t2","-1.0"}, "-periodic-pruning 300 -min-density 2.0 -max-candidates 100 -t1 -1.25 -N 2 -t2 -1.0"},
            { new String[]{"-periodic-pruning","300","-min-density","2.0","-max-candidates","100","-t1","-1.25","-N","3","-t2","-1.0"}, "-periodic-pruning 300 -min-density 2.0 -max-candidates 100 -t1 -1.25 -N 3 -t2 -1.0"},
            { new String[]{"-periodic-pruning","300","-min-density","2.0","-max-candidates","100","-t1","-1.25","-N","4","-t2","-1.0"}, "-periodic-pruning 300 -min-density 2.0 -max-candidates 100 -t1 -1.25 -N 4 -t2 -1.0"},
            { new String[]{"-periodic-pruning","300","-min-density","2.0","-max-candidates","200","-t1","-1.25","-N","2","-t2","-1.0"}, "-periodic-pruning 300 -min-density 2.0 -max-candidates 200 -t1 -1.25 -N 2 -t2 -1.0"},
            { new String[]{"-periodic-pruning","300","-min-density","2.0","-max-candidates","300","-t1","-1.25","-N","2","-t2","-1.0"}, "-periodic-pruning 300 -min-density 2.0 -max-candidates 300 -t1 -1.25 -N 2 -t2 -1.0"},
            { new String[]{"-periodic-pruning","200","-min-density","2.0","-max-candidates","100","-t1","-1.25","-N","2","-t2","-1.0"}, "-periodic-pruning 200 -min-density 2.0 -max-candidates 100 -t1 -1.25 -N 2 -t2 -1.0"},
            { new String[]{"-periodic-pruning","400","-min-density","2.0","-max-candidates","100","-t1","-1.25","-N","2","-t2","-1.0"}, "-periodic-pruning 400 -min-density 2.0 -max-candidates 100 -t1 -1.25 -N 2 -t2 -1.0"},
            { new String[]{"-periodic-pruning","300","-min-density","3.0","-max-candidates","100","-t1","-1.25","-N","2","-t2","-1.0"}, "-periodic-pruning 300 -min-density 3.0 -max-candidates 100 -t1 -1.25 -N 2 -t2 -1.0"},
            { new String[]{"-periodic-pruning","300","-min-density","4.0","-max-candidates","100","-t1","-1.25","-N","2","-t2","-1.0"}, "-periodic-pruning 300 -min-density 4.0 -max-candidates 100 -t1 -1.25 -N 2 -t2 -1.0"},
            { new String[]{"-periodic-pruning","300","-min-density","2.0","-max-candidates","100","-t1","-1.25","-N","2","-t2","1.0"}, "-periodic-pruning 300 -min-density 2.0 -max-candidates 100 -t1 -1.25 -N 2 -t2 1.0"},
            { new String[]{"-periodic-pruning","300","-min-density","2.0","-max-candidates","100","-t1","-1.25","-N","2","-t2","3.0"}, "-periodic-pruning 300 -min-density 2.0 -max-candidates 100 -t1 -1.25 -N 2 -t2 3.0"},
            { new String[]{"-periodic-pruning","300","-min-density","2.0","-max-candidates","100","-t1","0.5","-N","2","-t2","-1.0"}, "-periodic-pruning 300 -min-density 2.0 -max-candidates 100 -t1 0.5 -N 2 -t2 -1.0"},
            { new String[]{"-periodic-pruning","300","-min-density","2.0","-max-candidates","100","-t1","1.5","-N","2","-t2","-1.0"}, "-periodic-pruning 300 -min-density 2.0 -max-candidates 100 -t1 1.5 -N 2 -t2 -1.0"},
            { new String[]{"-periodic-pruning","300","-min-density","2.0","-max-candidates","100","-t1","-1.25","-M","-N","2","-t2","-1.0"}, "-periodic-pruning 300 -min-density 2.0 -max-candidates 100 -t1 -1.25 -M -N 2 -t2 -1.0"}
           });
    }
    ...
    public void test_Uniform() throws Exception {
        for(int iter=1; iter<=1; iter++) {
            ...
            Clusterer clusterer = AbstractClusterer.forName("weka.clusterers.Canopy", Arrays.copyOf(parameters, parameters.length));
